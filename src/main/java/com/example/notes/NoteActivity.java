...
public class NoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFileName = getIntent().getStringExtra(Util.EXTRAS_NOTE_FILENAME);
        if(mFileName != null && !mFileName.isEmpty() && mFileName.endsWith(Util.FILE_EXTENSION)) {
            mLoadedNote = Util.getNoteByFileName(getApplicationContext(), mFileName);
            if (mLoadedNote != null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_update: //or update
                validateAndSaveNote();
                break;
        ...
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(mLoadedNote != null && Util.deleteFile(getApplicationContext(), mFileName)) {
    ...
    private void validateAndSaveNote() {
        ...
        if(Util.saveNote(this, new Note(mNoteCreationTime, title, content))) { //success!
